    ...
    <div class="container pt-5 pb-md-4">
        <div class="row align-items-center">
            <div class="col-md-6 banner-left pt-md-0 pt-5">
                <h3 class="mb-sm-4 mb-3 title"><span class="type-js"><span
                            class="text-js">{{ $about->school_tagline }}</span></span></h3>
            ...
            <div class="col-md-6 banner-right mt-md-0 mt-4">
                <img class="img-fluid" src="{{ asset('frontend') }}/assets/images/b1.png" alt=" ">
            </div>
        </div>
    </div>
</section>

    ...
    <div class="card">
        <div class="card-body">
            <div class="card-header d-flex">
                <h5 class="card-title fw-semibold mt-2">Edit Guru</h5>
            </div>
            <div class="card-body">
                <form action="/teacher/update/{{ $teacher->id }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="teacher_name" id="teacher_name" class="form-control"
                            placeholder="Masukan Nama Guru" value="{{ $teacher->teacher_name }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="teacher_major" id="teacher_major" class="form-control"
                            placeholder="Masukan Jurusan Guru" value="{{ $teacher->teacher_major }}">
                    </div>
